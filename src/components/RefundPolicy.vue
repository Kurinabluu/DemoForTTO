<script setup>
import { ref } from 'vue'
import LegalDocShell from '@/components/LegalDocShell.vue'
...
<template>
    <LegalDocShell v-model:visible="showRefundPolicyDialog" :as-page="asPage" title="TTO退款政策">
        ...
        <div class="policy-section">
            ...
            <el-table class="refund-table" border :data="[
                ...
                <el-table-column prop="timeRange" label="取消时间" min-width="180" align="center" />
                <el-table-column prop="refundRate" label="退款比例" min-width="120" align="center" />
            </el-table>
        ...
        <div class="policy-section">
            ...
            <h3>3.1 申请渠道</h3>
            <ul>
                <li class="policy-paragraph">联系电话：{{ COMPANY.phone }}</li>
                <li class="policy-paragraph">咨询邮箱：{{ COMPANY.email }}</li>
                <li class="policy-paragraph">官方微信：{{ COMPANY.wechat }}</li>
            </ul>
        ...
        <div class="policy-section">
            <h2>第五章 附则</h2>
            <ul>
                <li class="policy-paragraph">5.1 本协议最终解释权归TTO所有</li>
        ...
        <div class="contact-info">
            【如需进一步了解退款细则，请联系{{ COMPANY.email }}，或点击”联系我们“获取更多帮助】
            <br>
            工作时间：{{ COMPANY.hoursAu }}；{{ COMPANY.hoursCn }}
        </div>
    </LegalDocShell>
</template>
